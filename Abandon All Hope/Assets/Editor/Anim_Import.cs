    ...
    void OnGUI() {
        ...
        if (File.Exists(asepriteLoc + "aseprite.exe")) {
            ...
            if (Directory.Exists(artFolder)) {
                ...
                /*update = */
                EditorGUILayout.Toggle("Update Existing Clips", update);
